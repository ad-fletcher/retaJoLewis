    ...
    <div id="about" className="w-full max-w-6xl mx-auto px-4 md:px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div className="flex items-center">
          <h2 className="text-4xl md:text-5xl font-semibold text-gray-900">About Reta Jo Lewis</h2>
        </div>
        <div className="prose prose-lg max-w-none text-base md:text-lg leading-relaxed text-gray-700">
