...
export default function Home() {
  return (
    <div>
      ...
      <div className="w-full flex flex-col items-center pb-6 md:pb-12 bg-white py-12 md:py-20">
        <About />
      </div>
      <div className="w-full flex flex-col items-center pb-6 md:pb-12">
        <Speak />
      </div>
      <div className="w-full flex flex-col items-center py-12 md:py-20 bg-[#f30126]">
